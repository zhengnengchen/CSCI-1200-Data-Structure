...
// Each different input train configuration to Separate is handled similarly
void SeparateComfortTestHelper(TrainCar* &train1, const std::string &which_test) {
    // UNCOMMENT THIS FUNCTION WHEN YOU'RE READY TO TEST SEPARATE
    
    std::cout << "============================================================================" << std::endl;
    std::cout << "SEPARATE COMFORT TRAINS " << which_test << std::endl;
    ...
    TrainCar* train2;
    TrainCar* train3;
    SeparateComfort(train1, train2, train3);
    assert (train1 == NULL);
    SanityCheck(train2);
    SanityCheck(train3);
    // record the IDs after separation
...
void StudentTests() {
  ...
  std::cout << "STUDENT TESTS" << std::endl;
    ...
    // Test SeparateComfort()
    
    std::cout << "TEST SEPARATE COMFORT" << std::endl;
    ...
    PushBack(t, TrainCar::MakePassengerCar());
    PushBack(t, TrainCar::MakeSleepingCar());
    SeparateComfortTestHelper(t, "#5");
    
    // Corner cases 1: no dining car
    t = NULL;
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakePassengerCar());
    PushBack(t, TrainCar::MakePassengerCar());
    SeparateComfortTestHelper(t, "#6");
    
    // Corner cases 2: 1 dining car
    t = NULL;
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakePassengerCar());
    PushBack(t, TrainCar::MakePassengerCar());
    PushBack(t, TrainCar::MakeDiningCar());
    SeparateComfortTestHelper(t, "#7");
    
    // Corner cases 3: More dining cars than passenger cars
    t = NULL;
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakePassengerCar());
    ...
    PushBack(t, TrainCar::MakeDiningCar());
    PushBack(t, TrainCar::MakeDiningCar());
    SeparateComfortTestHelper(t, "#8");
    
    // Corner cases 4: Engine cars than 2
    t = NULL;
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    ...
    PushBack(t, TrainCar::MakeDiningCar());
    PushBack(t, TrainCar::MakeDiningCar());
    SeparateComfortTestHelper(t, "#9");
    
    // Corner cases 5: Just engines
    t = NULL;
    PushBack(t, TrainCar::MakeEngine());
    PushBack(t, TrainCar::MakeEngine());
    SeparateComfortTestHelper(t, "#10");
    
    std::cout << "FINISH TESTING SEPARATE COMFORT" << std::endl;
